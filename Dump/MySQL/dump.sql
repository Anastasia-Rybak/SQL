...
CREATE TABLE `books` (
  ...
  `b_quantity` smallint(5) unsigned DEFAULT NULL,
  PRIMARY KEY (`b_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `books` VALUES (1,'Евгений Онегин',1985,2),(2,'Сказка о рыбаке и рыбке',1990,3),(3,'Основание и империя',2000,5),(4,'Психология программирования',1998,1),(5,'Язык программирования С++',1996,3),(6,'Курс теоретической физики',1981,12),(7,'Исскусство программирования',1993,7);
...
INSERT INTO `genres` VALUES (8,'Детектив'),(7,'История'),(5,'Классика'),(4,'Наука'),(10,'Политика'),(1,'Поэзия'),(2,'Программирование'),(3,'Психология'),(6,'Фантастика'),(9,'Философия');
...
INSERT INTO `subscribers` VALUES (1,'Иванов И.И.'),(2,'Петров И.И.'),(3,'Сидоров С.С.'),(4,'Сидоров С.С.');
...
-- Dump completed on 2018-07-31 15:31:31
